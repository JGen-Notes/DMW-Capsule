...
public class LangGenReadStatementTests {
  ...
  public void testConvertReadStatement01() {
    try {
      Ency ency = EncyManager.connectLocalForReadOnly((LangGenReadStatementTests.MODELS_PATH + "IMPWD03.ief"));
      ...
      MMObj _instance_1 = MMObj.getInstance(model, 
        model.getObjIdByName(ObjTypeCode.ACBLKBSD, PrpTypeCode.NAME, "READ_SOME_ENTITY_TYPE"));
