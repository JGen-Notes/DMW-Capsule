...
public class LangGenCreateStatementTests {
  ...
  public void testConvertCreateStatement01() {
    try {
      Ency ency = EncyManager.connectLocalForReadOnly((LangGenCreateStatementTests.MODELS_PATH + "IMPWD03.ief"));
      ...
      MMObj _instance_1 = MMObj.getInstance(model, 
        model.getObjIdByName(ObjTypeCode.ACBLKBSD, PrpTypeCode.NAME, "CREATE_SOME_ENTITY_TYPE"));
