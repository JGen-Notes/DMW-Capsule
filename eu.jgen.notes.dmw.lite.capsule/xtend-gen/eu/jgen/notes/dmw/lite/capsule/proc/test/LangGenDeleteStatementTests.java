...
public class LangGenDeleteStatementTests {
  ...
  public void testConvertCreateStatement01() {
    try {
      Ency ency = EncyManager.connectLocalForReadOnly((LangGenDeleteStatementTests.MODELS_PATH + "IMPWD03.ief"));
      ...
      MMObj _instance_1 = MMObj.getInstance(model, 
        model.getObjIdByName(ObjTypeCode.ACBLKBSD, PrpTypeCode.NAME, "DELETE_SOME_ENTITY_TYPE"));
