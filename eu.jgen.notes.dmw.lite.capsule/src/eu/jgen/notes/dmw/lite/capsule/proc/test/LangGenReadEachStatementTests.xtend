...
class LangGenReadEachStatementTests {
	...
	@Test
	def void testConvertReadStatement01() {
		...
		list1.add(
			...
			val acblkbsd = MMObj.getInstance(model,
				model.getObjIdByName(ObjTypeCode.ACBLKBSD, PrpTypeCode.NAME, "READ_EACH_SOME_ENTITY_TYPE")) as Acblkbsd
